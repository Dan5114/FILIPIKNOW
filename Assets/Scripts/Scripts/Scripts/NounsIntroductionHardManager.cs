...
{
    public class NounsIntroductionHardManager : MonoBehaviour
    {
        ...
        {
            "Welcome to Nouns - Hard Mode!",
            "Challenging Multiple Choice!",
            "Grade 3+ Level Questions!",
            "Example: 'Which is the abstract noun?'",
        ...
        {
            Debug.Log("========================================");
            Debug.Log("🎬 NounsIntroductionHardManager Start() called");
            Debug.Log("========================================");
        ...
        void SetupButtonListeners()
        {
            ...
            // Continue button - go to nouns hard game
            if (continueButton != null)
            {
        ...
        IEnumerator GenerateTextCoroutine()
        {
            ...
            // Get Hard-specific introduction text
            string fullText = GetHardIntroductionText();
        ...
        string GetHardIntroductionText()
        {
            // Return Hard-specific introduction text
        ...
        void OnContinueButtonClicked()
        {
            ...
            Debug.Log("========================================");
            Debug.Log("Proceeding to NounsHard game scene...");
            
            // Use SceneController if available, otherwise use direct SceneManager
            if (SceneController.Instance != null)
            {
                Debug.Log("Using SceneController.Instance to load NounsHard scene");
                SceneController.Instance.LoadScene("NounsHard");
            }
            else
            {
                Debug.LogWarning("⚠️ SceneController.Instance is null, using SceneManager directly");
                UnityEngine.SceneManagement.SceneManager.LoadScene("NounsHard");
            }
        }
        ...
        public void SkipAnimation()
        {
            ...
            if (scrollText != null)
            {
                scrollText.text = GetHardIntroductionText();
            }
