...
namespace Filipknow.UI
{
    public class IntroductionManager : MonoBehaviour
    {
        ...
        [Header("Text Content")]
        [SerializeField][TextArea(5, 20)] private string introductionText;
        ...
        {            
            ...
            if (SceneController.Instance != null)
            {
                SceneController.Instance.GoToTopicModuleGame();
            }
            else
            {
                Debug.LogWarning("⚠️ SceneController.Instance is null, using SceneManager directly");
                UnityEngine.SceneManagement.SceneManager.LoadScene(SM2Algorithm.Instance.CurrentTopic);
            }
        }
