...
public class NounsHardGameManager : MonoBehaviour
{
    ...
    public DifficultyLevel currentDifficulty = DifficultyLevel.Hard;
    ...
    // HARD MODE QUESTIONS - Grade 3+ Level (Advanced Analysis) - DepEd Philippines Curriculum Aligned
    private string[] questionsFilipino = {
        "Sa pangungusap na 'Ang kagandahan ng kalikasan ay dapat pangalagaan ng lahat,' alin ang pangngalang basal?",
        "Anong uri ng pangngalan ang 'kaguruan' sa pangungusap na 'Ang kaguruan ay nagpulong tungkol sa pagpapaunlad ng paaralan'?",
        "Sa pangungusap na 'Ang pagkakaisa ng mga mamamayan ay nagdadala ng kapayapaan sa bayan,' ilan ang pangngalan?",
        "Alin sa mga sumusunod ang pinaka-angkop na pangngalang lansakan para sa grupo ng mga hayop?",
        "Sa pangungusap na 'Ang pagmamahal sa bayan ay dakila at walang katumbas,' anong uri ng pangngalan ang 'pagmamahal'?",
        "Anong pangngalan ang tumutukoy sa grupo ng mga hayop na naglalakad sa damuhan?",
        "Sa pangungusap na 'Ang kaalaman ay susi sa tagumpay ng bawat mag-aaral,' alin ang pangngalang basal?",
        "Anong uri ng pangngalan ang 'pamahalaan' sa pangungusap na 'Ang pamahalaan ay nagbibigay ng tulong sa mga nangangailangan'?",
        "Sa pangungusap na 'Ang paggalang sa nakatatanda ay tanda ng mabuting pagpapalaki,' ilan ang pangngalan?",
        "Alin sa mga sumusunod ang pinaka-angkop na pangngalang pantangi para sa lalawigan ng Laguna?",
        "Sa pangungusap na 'Ang kagandahan ng kalikasan ay dapat pangalagaan,' alin ang pangngalang tahas?",
        "Anong uri ng pangngalan ang 'pamayanan' sa pangungusap na 'Ang pamayanan ay nagkakaisa sa panahon ng kalamidad'?",
        "Sa pangungusap na 'Ang pag-asa ay nagbibigay ng lakas sa mga taong nahihirapan,' alin ang pangngalang basal?",
        "Anong pangngalan ang tumutukoy sa grupo ng mga mag-aaral na nag-aaral sa parehong silid-aralan?",
        "Sa pangungusap na 'Ang pagmamahal sa pamilya ay hindi matutumbasan ng anumang kayamanan,' ilan ang pangngalan?"
    };
    
    private string[][] choicesFilipino = {
        new string[] { "kagandahan", "kalikasan", "pangalagaan", "lahat" },
        new string[] { "pangngalang pantangi", "pangngalang pambalana", "pangngalang lansakan", "pangngalang hango" },
        new string[] { "isa", "dalawa", "tatlo", "apat" },
        new string[] { "kawan", "pulutong", "grupo", "lahat ng nabanggit" },
        new string[] { "pangngalang tahas", "pangngalang basal", "pangngalang pantangi", "pangngalang pambalana" },
        new string[] { "kawan", "pulutong", "grupo", "lahat ng nabanggit" },
        new string[] { "kaalaman", "susi", "tagumpay", "mag-aaral" },
        new string[] { "pangngalang pantangi", "pangngalang pambalana", "pangngalang lansakan", "pangngalang hango" },
        new string[] { "isa", "dalawa", "tatlo", "apat" },
        new string[] { "Laguna Province", "Laguna", "Lungsod ng Laguna", "Laguna City" },
        new string[] { "kagandahan", "kalikasan", "pangalagaan", "dapat" },
        new string[] { "pangngalang pantangi", "pangngalang pambalana", "pangngalang lansakan", "pangngalang hango" },
        new string[] { "pag-asa", "lakas", "tao", "nahihirapan" },
        new string[] { "klase", "pangkat", "grupo", "lahat ng nabanggit" },
        new string[] { "isa", "dalawa", "tatlo", "apat" }
    };
    
    private string[][] correctAnswersFilipino = {
        new string[] { "kagandahan" },
        new string[] { "pangngalang lansakan" },
        new string[] { "tatlo" },
        new string[] { "lahat ng nabanggit" },
        new string[] { "pangngalang basal" },
        new string[] { "lahat ng nabanggit" },
        new string[] { "kaalaman" },
        new string[] { "pangngalang lansakan" },
        new string[] { "tatlo" },
        new string[] { "Laguna" },
        new string[] { "kalikasan" },
        new string[] { "pangngalang lansakan" },
        new string[] { "pag-asa" },
        new string[] { "lahat ng nabanggit" },
        new string[] { "tatlo" }
    ...
    private string[] questionsEnglish = {
        "In the sentence 'Ang kagandahan ng kalikasan ay dapat pangalagaan ng lahat,' which is the abstract noun?",
        "What type of noun is 'kaguruan' in the sentence 'Ang kaguruan ay nagpulong tungkol sa pagpapaunlad ng paaralan'?",
        "In the sentence 'Ang pagkakaisa ng mga mamamayan ay nagdadala ng kapayapaan sa bayan,' how many nouns are there?",
        "Which of the following is the most appropriate collective noun for a group of animals?",
        "In the sentence 'Ang pagmamahal sa bayan ay dakila at walang katumbas,' what type of noun is 'pagmamahal'?",
        "What noun refers to a group of animals walking in the grass?",
        "In the sentence 'Ang kaalaman ay susi sa tagumpay ng bawat mag-aaral,' which is the abstract noun?",
        "What type of noun is 'pamahalaan' in the sentence 'Ang pamahalaan ay nagbibigay ng tulong sa mga nangangailangan'?",
        "In the sentence 'Ang paggalang sa nakatatanda ay tanda ng mabuting pagpapalaki,' how many nouns are there?",
        "Which of the following is the most appropriate proper noun for the province of Laguna?",
        "In the sentence 'Ang kagandahan ng kalikasan ay dapat pangalagaan,' which is the concrete noun?",
        "What type of noun is 'pamayanan' in the sentence 'Ang pamayanan ay nagkakaisa sa panahon ng kalamidad'?",
        "In the sentence 'Ang pag-asa ay nagbibigay ng lakas sa mga taong nahihirapan,' which is the abstract noun?",
        "What noun refers to a group of students studying in the same classroom?",
        "In the sentence 'Ang pagmamahal sa pamilya ay hindi matutumbasan ng anumang kayamanan,' how many nouns are there?"
    };
    
    private string[][] choicesEnglish = {
        new string[] { "kagandahan", "kalikasan", "pangalagaan", "lahat" },
        new string[] { "proper noun", "common noun", "collective noun", "derived noun" },
        new string[] { "one", "two", "three", "four" },
        new string[] { "kawan", "pulutong", "grupo", "all of the above" },
        new string[] { "concrete noun", "abstract noun", "proper noun", "common noun" },
        new string[] { "kawan", "pulutong", "grupo", "all of the above" },
        new string[] { "kaalaman", "susi", "tagumpay", "mag-aaral" },
        new string[] { "proper noun", "common noun", "collective noun", "derived noun" },
        new string[] { "one", "two", "three", "four" },
        ...
        new string[] { "proper noun", "common noun", "collective noun", "derived noun" },
        new string[] { "pag-asa", "lakas", "tao", "nahihirapan" },
        new string[] { "klase", "pangkat", "grupo", "all of the above" },
        new string[] { "one", "two", "three", "four" }
    };
    
    private string[][] correctAnswersEnglish = {
        new string[] { "kagandahan" },
        new string[] { "collective noun" },
        new string[] { "three" },
        new string[] { "all of the above" },
        new string[] { "abstract noun" },
        new string[] { "all of the above" },
        new string[] { "kaalaman" },
        new string[] { "collective noun" },
        new string[] { "three" },
    ...
    void Start()
    {
        Debug.Log("🎯 NounsHardGameManager Start - Hard Difficulty");
        
        // Set difficulty to Hard directly
    ...
    void SetupTypewriter()
    {
        ...
        if (typewriterEffect != null)
        {
            ...
            Debug.Log("NounsHardGameManager: Set typing speed to 0.05f for faster typewriter effect");
            
            // Set the font first
            if (timesBoldFont != null)
            {
                typewriterEffect.SetFont(timesBoldFont);
                Debug.Log($"NounsHardGameManager: Set font {timesBoldFont.name} to typewriter");
            }
            else if (useUniversalFont && FilipknowFontManager.Instance != null)
            {
                typewriterEffect.RefreshUniversalFont();
                Debug.Log("NounsHardGameManager: Applied universal font to typewriter");
            }
    ...
    void SetupButtons()
    {
        ...
        // Setup choice buttons for Hard Mode (Multiple Choice with challenging questions)
        if (choiceButtons != null)
        {
            for (int i = 0; i < choiceButtons.Length; i++)
            {
                ...
                {
                    Debug.LogWarning($"Choice button at index {i} is null - skipping setup");
                }
            }
    ...
    string GetIntroductionMessage()
    {
        return currentDifficulty switch
        {
            ...
            DifficultyLevel.Hard => "Hello! I am Teacher Ana.\n\n" +
                                  ...
                                  "In Hard level, you will face challenging multiple choice questions:\n\n" +
                                  "🎯 You will learn:\n" +
                                  "• Identifying abstract nouns in complex sentences\n" +
                                  "• Recognizing collective and derived nouns\n" +
                                  "• Counting nouns in complex sentences\n" +
                                  "• Understanding noun types in context\n\n" +
                                  "Example: 'In the sentence 'Ang kagandahan ng kalikasan ay dapat pangalagaan,' which is the abstract noun?'\n" +
                                  "Answer: 'kagandahan' (beauty)\n\n" +
    ...
    void StartGame()
    {
        ...
        {
            Debug.LogWarning("⚠️ Choice buttons array is null - please assign choice buttons in the Inspector");
        }
        continueButton.gameObject.SetActive(false);
        backButton.gameObject.SetActive(true);
        
        // Use legacy system for Hard difficulty to maintain same flow as Easy/Medium
        Debug.Log($"🎯 Using legacy system for Hard difficulty");
        DisplayQuestion();
    }
    ...
    void DisplayQuestion()
    {
        ...
        // Handle Hard difficulty - use unified questions with same flow as Easy/Medium
        if (currentQuestions.Count > 0 && currentQuestion < currentQuestions.Count)
        {
            Debug.Log($"Using Hard question {currentQuestion} - SAME FLOW AS EASY/MEDIUM");
            currentQuestionData = currentQuestions[currentQuestion];
            
            // Use appropriate text based on question type
            string questionText = currentQuestionData.questionType == QuestionType.FillInTheBlank 
                ? currentQuestionData.sentenceTemplate 
            ...
            else if (typewriterEffect != null)
            {
                ...
                // Start typewriter with completion callback - add null check
                ...
                {
                    Debug.LogError("❌ Question text is null or empty!");
                    // Fallback: show choices immediately
                    DisplayChoices(choices);
                }
            }
    ...
    void DisplayChoices(string[] choices)
    {
        ...
        for (int i = 0; i < choiceButtons.Length; i++)
        {
            ...
            {
                Debug.LogWarning($"Button {i} is null - skipping");
            }
        }
    ...
    void ProcessAnswer(string selectedAnswer, string correctAnswer, bool isCorrect, int buttonIndex)
    {
        ...
        // Handle Hard difficulty - use unified question data
        if (currentQuestionData != null)
        {
            Debug.Log("Hard difficulty: Using unified question data");
            
            // For Hard Mode, we need to find the correct answer from the choices
            if (currentQuestionData.questionType == QuestionType.MultipleChoice)
            {
                // Use the correct choice index for multiple choice questions
                if (currentQuestionData.correctChoiceIndex >= 0 && 
                    currentQuestionData.correctChoiceIndex < currentQuestionData.choices.Length)
                {
                    correctAnswer = currentQuestionData.choices[currentQuestionData.correctChoiceIndex];
                    isCorrect = selectedAnswer.Equals(correctAnswer, StringComparison.OrdinalIgnoreCase);
                }
                else
                {
                    // Fallback: check against acceptable answers
                    correctAnswer = currentQuestionData.acceptableAnswers[0];
                    isCorrect = currentQuestionData.acceptableAnswers.Contains(selectedAnswer);
                }
            }
            else if (currentQuestionData.questionType == QuestionType.FillInTheBlank)
            {
                // Use blank word for fill-in-the-blank questions
            ...
            Debug.Log($"Hard answer check: '{selectedAnswer}' vs '{correctAnswer}' = {isCorrect}");
        }
        ...
        if (GameAudioManager.Instance != null)
        {
            if (isCorrect)
            {
                ...
                Debug.Log("✅ NounsHardGameManager: Playing correct answer sound");
            }
            else
            {
                GameAudioManager.Instance.PlayWrongAnswer();
                Debug.Log("❌ NounsHardGameManager: Playing wrong answer sound");
            }
        }
