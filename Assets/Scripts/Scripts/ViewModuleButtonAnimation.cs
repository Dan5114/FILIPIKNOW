...
public class ViewModuleButtonAnimation : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    private void PlaySound(AudioClip clip)
    {
        if (audioSource != null && clip != null)
        {
            ...
            Debug.Log("ViewModuleButtonAnimation: Playing sound - " + clip.name);
        }
        else
        {
            if (audioSource == null)
                Debug.LogError("ViewModuleButtonAnimation: AudioSource is null!");
            if (clip == null)
                Debug.LogError("ViewModuleButtonAnimation: AudioClip is null!");
        }
    }
}
